...
const FormularioProyecto = () => {
  ...
  return (
    <form
      className="border-4 border-Secundario_2  py-5 px-5 md:max-w-2xl mx-0 rounded-3xl flex flex-col relative left-80 bottom-60"
      ...
      <div className="flex flex-row mb-7">
        <div className="flex flex-col md:flex-row justify-between mr-3">
          <label
            ...
            htmlFor="descripcion"
          ></label>
          <div className="flex flex-col md:col-row items-center w-full md:w-[230px] my-2 md:rounded-[33.695px] ">
            <Link
              to="#"
