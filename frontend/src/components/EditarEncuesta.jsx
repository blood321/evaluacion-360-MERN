                              ...
                              <div className="mt-5">
                                  <div className="form">
                                      <div className="md:flex flex-row md:space-x-4 w-full text-xs">
                                          ...
                                          <div className="mb-3 space-y-2 w-full text-xs">
                                              <label className="font-semibold text-gray-600 py-2">Temáticas
                                              </label>
                                              <select
                                      ...
                                      <div className="mb-3 space-y-2 w-full text-xs">
                                          <label className="font-semibold text-gray-600 py-2">Preguntas</label>
                                          <select
                                              className="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full "
                                              required="required"
                                              multiple
                                      ...
                                      <div className="mb-3 space-y-2 w-full text-xs">
                                          <label className="font-semibold text-gray-600 py-2">Fecha Limite</label>
                                          <input
                                      ...
                                      <div className="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                          <button
                                              ...
                                              className="mb-2 md:mb-0 bg-red-500  border-red-500  hover:bg-red-600 text-white  px-5 py-2 text-sm shadow-sm font-medium tracking-wider border  rounded-full hover:shadow-lg "
                                          >
                                              Cancelar
                                          </button>
                                          <button
                                              onClick={handleSave}
                                              className="mb-2 md:mb-0 bg-gradient-to-r from-Principal_1 to-Principal_2 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500"
                                          >
                                              Guardar
                                          </button>
                                      </div>
