...
const Proyecto = () => {
  ...
  return cargando ? (
    ...
    <>
      ...
      <button
        type="button"
        className="text-md px-3 py-3 w-full md:w-auto rounded-lg capitalize font-bold bg-sky-400 text-white text-center mt-5 flex gap-1 items-center justify-center"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
