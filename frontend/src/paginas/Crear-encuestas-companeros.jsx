  ...
  return (
    <div className="px-auto px-3">
      <div className="md:flex md:justify-between mt-2">
        <p className="px-3 pr-2  font-semibold text-[19px] text-Secundario_2/[0.7]">
          Elige una temática para tu encuesta y las preguntas se adaptarán a
          ella. Puedes cambiar la temática según lo necesites.{" "}
