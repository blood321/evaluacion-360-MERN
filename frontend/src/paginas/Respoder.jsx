...
const Responder = () => {
    ...
    useEffect(() => {
        ...
        const totalPreguntasEsperadas = preguntas.length * instructores.length * preguntasPorInstructor
    ...
    const handleNext = () => {
        setPreguntaActual(prevState => Math.min(preguntas.length - 1, prevState + 1))
    }
