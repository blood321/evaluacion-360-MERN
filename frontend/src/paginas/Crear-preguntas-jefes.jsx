...
const CrearPreguntasJefes = () => {
 ...
 console.log(tematicaSeleccionada)
    ...
    const preguntasFiltradas = preguntas.filter((pregunta) => {
        ...
        const esPaginacompañeros =location.pathname==="/inicio-admin/Crear-preguntas-companeros"
        const espaginaJefes =location.pathname==="/inicio-admin/Crear-preguntas-jefes"
